from rest_framework.serializers import (IntegerField, CharField, Serializer, ModelSerializer, ModelSerializer,
...
class ThinNoteSerializer(ModelSerializer):
    url = HyperlinkedIdentityField(view_name='notes-detail')  # позволит добавить 'url' и 'author' к fields
    class Meta:
        model = Note
        fields = ('id', 'title', 'url')
"""
